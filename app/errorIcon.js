...
/*
err_n_icon.prototype.showerror = function($element, _bColor, _bSize) {
    return _showErrFunc($element, _bColor, _bSize);
}

err_n_icon.prototype.showIconError = function($element, _iconName, _iconSize, _iconColor, _position) {
    return _ErrIcon($element, _iconName, _iconSize, _iconColor, _position);
}
*/
var MyApp = function () {
    var flag = false;
...
var showFerror = function(){
    _showErrFunc($("span"), "blue", "2px");
    this.checkNode = new _get_nodeType($("span"));
}
showFerror.prototype.showerror = function($element, _bColor, _bSize) {
    return _showErrFunc($element, _bColor, _bSize);
}

var errFicon = function(){
    _ErrIcon($("input"), "info-circle", null, "blue", "right");
    this.checkNode = new _get_nodeType($("span"));
}

errFicon.prototype.showIconError = function($element, _iconName, _iconSize, _iconColor, _position) {
    this.checkNode.getnodetype($element);
    return _ErrIcon($element, _iconName, _iconSize, _iconColor, _position);
}
...
*/
var showErrFunc = function (element) {
